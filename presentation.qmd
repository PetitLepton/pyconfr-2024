...
## Dumas du tuyau : trois écrivains et un lecteur{.center}

```{mermaid}
flowchart TD

	subgraph measures[stations]
	  getstatistics[statistiques]
	end

	subgraph meteoblue
	  getforecasts[prévisions]
	...
	combine[combinaison] --> timeseries[(série finale)]
	statistics --> combine
	forecasts --> combine
	history --> combine

style measures color:#000
style meteoblue color:#000
