...
## sencrop, des stations météo connectées {background-opacity=0.25 background-image="./images/raincrop.jpg"}
...
## sencrop, les pros de l'agro {background-image="./images/agro.gif"}
